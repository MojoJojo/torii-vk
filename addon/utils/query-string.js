...
export default Ember.Object.extend({
  init: function() {
    ...
    let requiredParams = this.requiredParams.slice();
    let optionalParams = this.optionalParams.slice() || [];
    this.urlParams         = Ember.A(requiredParams).uniq();
    this.optionalUrlParams = Ember.A(optionalParams).uniq();
